...
export default {
  ...
  data () {
    return {
          chartData: {
          columns: ['shijian', 'anliang_hour','biaozhunmuluyuejia'],
          rows: []
        },
    } 
  },
        ...
        .then((response) => {
         ...
         /*   var s6 = [
           ...
           this.chartData.rows = s6 */
             ...
             var s1 = { shijian: v[i].fields.shijian, anliang_hour: v[i].fields.anliang_hour, biaozhunmuluyuejia: v[i].fields.biaozhunmuluyuejia}
